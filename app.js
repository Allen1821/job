(() => {
  ...
  const SEED_JOBS = [
    { id: "s01", desc: "On-board crew for Breeze flights out of Tampa — cabin safety checks, boarding, snack and beverage service, and guest care.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Tampa, FL", group: "Tampa Bay", priority: "High", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Age 21+; HS diploma/GED; passport with 6+ months validity; live within 2 hours of TPA. Only one Breeze FA application every 3 months—choose Tampa first.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761949003" },
    { id: "s02", desc: "Airport counter and gate work at Clearwater — checking in passengers, tagging bags, boarding flights and helping travelers.", airline: "Allegiant Air", position: "Customer Service Agent", location: "Clearwater, FL", group: "Tampa Bay", priority: "High", type: "Part-time", pay: "$15.00 / hour", notes: "HS diploma/GED; 1+ year customer service; valid driver's license; flexible nights, weekends and holidays. Strong local pathway into aviation.", link: "https://jobs.lever.co/allegiantair/e5b5ff00-e5e5-46dc-8ae7-db35e54deccc" },
    { id: "s03", desc: "Airport check-in desk at TPA — computerized check-in, seat assignments, document checks and boarding assistance.", airline: "Menzies Aviation", position: "Passenger Service Agent (Part Time)", location: "Tampa, FL (TPA)", group: "Tampa Bay", priority: "High", type: "Part-time", pay: "$16.00 / hour", notes: "Computerized passenger check-in, seat assignments and travel assistance. Paid training, uniform and flight benefits listed.", link: "https://recruiting2.ultipro.com/MEN1002MENZI/JobBoard/c62dfe4d-64ad-4642-8cd0-17a30715a697/OpportunityDetail?opportunityId=48fe50fd-9e55-42aa-a021-5dbd4050d5f8" },
    { id: "s04", desc: "Same passenger check-in role at TPA but serving Copa Airlines flights — requires fluent English and Spanish.", airline: "Menzies Aviation", position: "Passenger Service Agent — English/Spanish", location: "Tampa, FL (TPA)", group: "Tampa Bay", priority: "Medium", type: "Part-time", pay: "$16.00 / hour", notes: "Copa Airlines passenger-service assignment. Apply only if professionally fluent in both English and Spanish.", link: "https://recruiting2.ultipro.com/MEN1002MENZI/JobBoard/c62dfe4d-64ad-4642-8cd0-17a30715a697/OpportunityDetail?opportunityId=e933e4bf-7caa-4595-8d5c-69c531c2b8d2&postingId=a93dae80-71d7-4408-8ea2-5d904e4a4a0c" },
    { id: "s05", desc: "Behind-the-scenes cabin support — stocking aircraft with snacks, drinks and supplies and keeping galley carts organized.", airline: "Allegiant Air", position: "Commissary Agent", location: "Clearwater, FL", group: "Tampa Bay", priority: "Medium", type: "Part-time", pay: "See official posting", notes: "Official Clearwater station opening. Builds airline experience through aircraft provisioning, organization and safety procedures.", link: "https://jobs.lever.co/allegiantair?location=Clearwater%2C+FL" },
    { id: "s06", desc: "Paid training at JetBlue University in Orlando to become a flight attendant — then cabin safety and customer service on JetBlue flights.", airline: "JetBlue", position: "Inflight Crew Trainee", location: "Orlando, FL", group: "Orlando", priority: "High", type: "Full-time / trainee", pay: "$26.03–$69.90 / flight hour", notes: "Age 21+; HS diploma/GED; 2 years face-to-face customer service; passport with 12+ months validity; safety, teamwork and flexible scheduling.", link: "https://careers.jetblue.com/job/Orlando-Inflight-Crew-Trainee-FL-32827/1409071000/" },
    { id: "s07", desc: "Cabin crew on Frontier flights — safety demos, boarding, onboard sales and service; could be based at MCO, TPA or MIA.", airline: "Frontier Airlines", position: "Flight Attendant", location: "Multiple bases incl. Orlando, Tampa, Miami", group: "Orlando", priority: "High", type: "Full-time", pay: "See official posting", notes: "Age 20+; HS diploma/GED; passport with 14+ months validity; willing to relocate. Florida bases listed include MCO, TPA and MIA.", link: "https://recruiting2.ultipro.com/FRO1003FTAIR/JobBoard/1efcf859-1b48-4a31-b014-ef62bdcab988/OpportunityDetail?opportunityId=a0b7a22c-5ca9-4802-89a2-0edc6714c012" },
    { id: "s08", desc: "On-board crew for Breeze flights out of Orlando — cabin safety checks, boarding, snack and beverage service, and guest care.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Orlando, FL", group: "Orlando", priority: "High", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Age 21+; HS diploma/GED; passport with 6+ months validity; live within 2 hours of MCO. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7785954003" },
    { id: "s09", desc: "Under-wing airport work at MCO — loading and unloading bags and cargo, marshalling aircraft, water and lavatory service.", airline: "Swissport", position: "Ramp Agent", location: "Orlando, FL", group: "Orlando", priority: "Medium", type: "Permanent part-time", pay: "$16.50 / hour", notes: "Valid driver's license; safety awareness; lift up to 70 lb; flexible shifts. Mechanic experience transfers well to equipment and ramp operations.", link: "https://careers.swissport.com/jobs/7938?lang=en-us" },
    { id: "s10", desc: "Airport passenger service at MCO — check-in, ticketing, baggage and gate announcements; requires fluent English and French.", airline: "Swissport", position: "Passenger Service Agent — English/French", location: "Orlando, FL (MCO)", group: "Orlando", priority: "Medium", type: "Permanent part-time", pay: "$16.50 / hour", notes: "Check-in, ticketing, baggage, gate announcements and special-assistance duties. Apply only if fluent in English and French; posting also mentions Spanish.", link: "https://careers.swissport.com/jobs/7939?lang=en-us" },
    { id: "s11", desc: "On-board crew for Breeze flights out of Fort Myers — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Fort Myers, FL", group: "Other Florida", priority: "Medium", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of RSW. Only one Breeze FA application every 3 months; do not submit if applying to Tampa.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761946003" },
    { id: "s12", desc: "On-board crew for Breeze flights out of Vero Beach — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Vero Beach, FL", group: "Other Florida", priority: "Medium", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of VRB. Only one Breeze FA application every 3 months; do not submit if applying to Tampa.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761953003" },
    { id: "s13", desc: "On-board crew for Breeze flights out of Fort Lauderdale — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Fort Lauderdale, FL", group: "Other Florida", priority: "Medium", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of FLL. Only one Breeze FA application every 3 months; do not submit if applying to Tampa.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761959003" },
    { id: "s14", desc: "Cabin crew on private charter flights — safety briefings, cabin prep and personalized passenger service, often as the solo attendant.", airline: "Contour Airlines", position: "Flight Attendant - Charter Service", location: "Fort Lauderdale, FL", group: "Other Florida", priority: "Medium", type: "Full-time", pay: "$42,000–$52,452 / year", notes: "Charter cabin role emphasizing passenger safety, security, comfort and high-level customer service. High school education listed.", link: "https://www.paycomonline.net/v4/ats/web.php/portal/4E8FCB0F31AC88147F0DB7B85238B354/jobs/388772" },
    { id: "s15", desc: "Regional cabin crew flying as American Eagle — safety and service on Embraer jets; Miami is a home base option.", airline: "Envoy Air", position: "Flight Attendant", location: "Bases include Miami, FL", group: "Other Florida", priority: "Medium", type: "Full-time", pay: "$29.73 / flight hour + possible bonus", notes: "Miami is a listed domicile; must accept base assignment/relocation. Official page advertises Apply Now and current enhanced entry pay.", link: "https://www.envoyair.com/careers/flight-attendants/" },
    { id: "s16", desc: "Two-in-one airport role at Lakeland — passenger check-in and boarding plus ramp work like bags and aircraft turnarounds.", airline: "Avelo Airlines", position: "Airport Crewmember - PT", location: "Lakeland, FL", group: "Other Florida", priority: "Medium", type: "Part-time", pay: "$18.00 / hour", notes: "Combined customer-service and ramp role. HS diploma/GED, driver's license, background/drug screening and ability to lift up to 70 lb.", link: "https://recruiting.paylocity.com/recruiting/jobs/Details/3636532/Avelo-Airlines-Inc/Airport-Crewmember---PT" },
    { id: "s17", desc: "Mainline Delta cabin crew — safety, boarding and full in-flight service; 7-week paid training in Atlanta before base assignment.", airline: "Delta Air Lines", position: "Flight Attendant - 2027 Classes", location: "Base assigned after training", group: "National / Relocation", priority: "High", type: "Full-time", pay: "See official posting", notes: "Age 21+; HS diploma/GED; valid passport required with 30 months remaining by training; 7-week training in Atlanta. Apply quickly—window may close without a set date.", link: "https://www.delta.com/us/en/careers/flight-attendant-careers" },
    { id: "s18", desc: "Regional cabin crew on flights operated for Delta, United, American and Alaska — training in Salt Lake City.", airline: "SkyWest Airlines", position: "Flight Attendant", location: "Multiple U.S. locations", group: "National / Relocation", priority: "High", type: "Full-time", pay: "See official posting", notes: "Official current posting. Base is assigned based on operational need; training is held in Salt Lake City.", link: "https://jobs.skywest.com/skywest-airlines/jobs/16704?lang=en-us" },
    { id: "s19", desc: "Regional cabin crew on American Eagle CRJ jets — safety checks, boarding and in-flight service; 4 weeks paid training in Charlotte.", airline: "PSA Airlines", position: "Flight Attendant", location: "Bases: Charlotte, Dayton, Washington, Dallas, Philadelphia", group: "National / Relocation", priority: "High", type: "Full-time", pay: "$27.06 / flight hour", notes: "Age 20+; HS diploma plus 2 years customer-facing experience or college degree; passport; 4 weeks paid training in Charlotte; relocation may be required.", link: "https://psaairlines.com/flight-attendants/" },
    { id: "s20", desc: "Cabin crew on Delta Connection regional jets — safety-first onboard service across Endeavor's hub network.", airline: "Endeavor Air", position: "Flight Attendant", location: "Hubs incl. Atlanta, Cincinnati, Detroit, Minneapolis, New York, Raleigh-Durham", group: "National / Relocation", priority: "High", type: "Full-time", pay: "See official posting", notes: "Official page says apply today. Safety-focused regional role operating as Delta Connection; base assignment may require relocation.", link: "https://www.endeavorair.com/content/endeavor-air/en_us/careers/flight-attendants.html" },
    { id: "s21", desc: "Cabin crew on Avelo 737 flights from New Haven — safety duties and friendly onboard service; 75 flight hours guaranteed monthly.", airline: "Avelo Airlines", position: "Flight Attendant", location: "New Haven, CT", group: "National / Relocation", priority: "Medium", type: "Full-time", pay: "$28 / flight hour; 75-hour monthly guarantee", notes: "Age 21+; passport with 6+ months validity; must report to base within 2 hours; lifting/pushing requirements; relocation may be required.", link: "https://recruiting.paylocity.com/recruiting/jobs/Details/4280858/Avelo-Airlines-Inc/Flight-Attendant" },
    { id: "s22", desc: "Cabin crew for Contour's scheduled and charter flying from Dallas/Fort Worth — safety and personalized service.", airline: "Contour Airlines", position: "Flight Attendant", location: "Dallas/Fort Worth, TX", group: "National / Relocation", priority: "Medium", type: "Full-time", pay: "See official posting", notes: "Official Contour opening. Passenger safety, security, comfort and customer service; relocation required.", link: "https://www.paycomonline.net/v4/ats/web.php/portal/4E8FCB0F31AC88147F0DB7B85238B354/jobs/325324" },
    { id: "s23", desc: "Cabin crew for Contour's scheduled and charter flying from Phoenix — safety and personalized service.", airline: "Contour Airlines", position: "Flight Attendant", location: "Phoenix, AZ", group: "National / Relocation", priority: "Medium", type: "Full-time", pay: "See official posting", notes: "Official Contour opening. Passenger safety, security, comfort and customer service; relocation required.", link: "https://www.paycomonline.net/v4/ats/web.php/portal/4E8FCB0F31AC88147F0DB7B85238B354/jobs/322835" },
    { id: "s24", desc: "Regional cabin crew flying as American Eagle — safety and onboard service from Charlotte, Philadelphia or Harrisburg.", airline: "Piedmont Airlines", position: "Flight Attendant", location: "Bases: Charlotte, Philadelphia, Harrisburg", group: "National / Relocation", priority: "Medium", type: "Full-time", pay: "$28.08 / flight hour + $2.00 per diem", notes: "Age 21+; HS diploma/GED; passport and driver's license. Two years customer service preferred. Official page links to current Workday openings.", link: "https://piedmont-airlines.com/flight-attendant/" },
    { id: "s25", desc: "Cabin crew on Sun Country leisure and charter flights — safety and service; hiring is per specific base.", airline: "Sun Country Airlines", position: "Flight Attendant", location: "Bases: Minneapolis, Laughlin, Las Vegas, Gulfport", group: "National / Relocation", priority: "Medium", type: "Full-time", pay: "See official posting", notes: "Age 20+ by end of training; HS diploma; 2 years direct customer service; passport with 6+ months validity. Apply to a specific base when listed.", link: "https://careers.suncountry.com/flight-attendants" },
    { id: "s26", desc: "Cabin crew on private charter flights out of New York — safety briefings, cabin prep and high-touch passenger service.", airline: "Contour Airlines", position: "Flight Attendant - Charter Service", location: "New York, NY", group: "National / Relocation", priority: "Low", type: "Full-time", pay: "See official posting", notes: "Official charter-service opening. Higher relocation cost from Florida; keep as a backup.", link: "https://www.paycomonline.net/v4/ats/web.php/portal/4E8FCB0F31AC88147F0DB7B85238B354/jobs/331558" },
    { id: "s27", desc: "On-board crew for Breeze flights out of Charleston — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Charleston, SC", group: "National / Relocation", priority: "Low", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of base. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7792798003" },
    { id: "s28", desc: "On-board crew for Breeze flights out of New Orleans — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "New Orleans, LA", group: "National / Relocation", priority: "Low", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of base. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761927003" },
    { id: "s29", desc: "On-board crew for Breeze flights out of Norfolk — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Norfolk, VA", group: "National / Relocation", priority: "Low", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of base. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761929003" },
    { id: "s30", desc: "On-board crew for Breeze flights out of Providence — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Providence, RI", group: "National / Relocation", priority: "Low", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of base. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761932003" },
    { id: "s31", desc: "On-board crew for Breeze flights from the Hartford/New Haven co-domicile — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Windsor Locks, CT", group: "National / Relocation", priority: "Low", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "BDL/HVN co-domicile may require seasonal work at both airports. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761879003" },
    { id: "s32", desc: "On-board crew for Breeze flights out of Akron — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Akron, OH", group: "National / Relocation", priority: "Low", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of base. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761906003" },
    { id: "s33", desc: "On-board crew for Breeze flights out of Provo — cabin safety, boarding and in-flight service.", airline: "Breeze Airways", position: "Flight Attendant - Part Time", location: "Provo, UT", group: "National / Relocation", priority: "Low", type: "Part-time", pay: "$25.00–$37.50 / flight hour", notes: "Must live within 2 hours of base. Only one Breeze FA application every 3 months.", link: "https://job-boards.greenhouse.io/breezeairways/jobs/7761935003" },
    { id: "s34", desc: "Regional cabin crew on Embraer 170/175 jets flying for American, Delta and United — 19 days paid training with hotel included.", airline: "Republic Airways", position: "Flight Attendant", location: "Multiple U.S. crew bases", group: "National / Relocation", priority: "Low", type: "Full-time", pay: "Starting above $27 / flight hour; 75-hour guarantee", notes: "Paid 19-day training with hotel and transportation. No live flight-attendant requisition was visible in the current job search, so monitor or join the talent community.", link: "https://careers.rjet.com/airline-careers/flight-attendant/" },
  ];
  ...
  function renderCard(app) {
    ...
    const hasApplied = app.status !== "Not Started";
    ...
    card.innerHTML = `
      ...
      ${app.desc ? `<p class="card-desc">${escapeHtml(app.desc)}</p>` : ""}
      ...
      <div class="card-actions">
        <label class="applied-check"><input type="checkbox" ${hasApplied ? "checked" : ""} aria-label="Mark as applied" /> APPLIED</label>
        ${applyBtn}
        <button class="btn btn-ghost" data-action="edit">EDIT</button>
      </div>
    `;

    card.querySelector(".applied-check input").addEventListener("change", (e) => {
      if (e.target.checked) {
        app.status = "Applied";
        if (!app.date) app.date = new Date().toISOString().slice(0, 10);
      } else {
  ...
  document.getElementById("btn-delete").addEventListener("click", () => {
    ...
    if (!app) return;
    if (confirm(`Delete the ${app.airline} — ${app.position} entry?`)) {
  ...
  document.getElementById("btn-export").addEventListener("click", () => {
    const header = ["Airline", "Position", "Description", "Location", "Group", "Priority", "Employment Type", "Pay", "Date Applied", "Status", "Link", "Notes"];
    const rows = applications.map((a) =>
      [a.airline, a.position, a.desc, a.location, a.group, a.priority, a.type, a.pay, a.date, a.status, a.link, a.notes]
        .map(csvCell)
        .join(",")
    );
  ...
  function parseCsv(text) {
    ...
    let cols = {
      ...
      desc: findCol("description", "summary", "duties"),
    ...
    if (!hasHeader) {
      cols = { airline: 0, position: 1, desc: 2, location: 3, group: 4, priority: 5, type: 6, pay: 7, date: 8, status: 9, link: 10, notes: 11 };
    }
